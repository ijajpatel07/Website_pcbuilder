...
<div class="Profile-page">
        <div class="form">
          <form class="regsiter-form" method= "POST" action="logout.php">
            ...
            <p ><a href="profile_edit.php" style="text-decoration:underline; font-size:1.7vw;">Edit</a></p>
            <button type="submit" name="logout" value="logout">Logout</button>
            <button type="submit" name="Delete account" value="Delete account" style="margin-top:2vw" >Delete Account</button>
